    ...
    stages {
        ...
        stage("deploy") {
            input {
                ...
                ok "DONE"
                parameters {
                    choice(name: "ONE", choices: ['dev', 'staging', 'prod'], description: 'environments to deploy')
                    choice(name: "TWO", choices: ['dev', 'staging', 'prod'], description: 'environments to deploy')
                }
            }
            steps{
                script {
